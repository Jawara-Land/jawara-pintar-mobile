...
class FinanceExpensesScreen extends GetView<FinanceController> {
    ...
    return Obx(() {
      ...
      if (controller.errorMessage.value.isNotEmpty &&
        ...
        return AppEmptyState(
          ...
          onAction: controller.fetchAllExpenses,
        );
      }
      ...
      return RefreshIndicator(
        onRefresh: controller.fetchAllExpenses,
        child: ListView.separated(
          ...
          itemBuilder: (_, index) {
            ...
            return ListTile(
              ...
              subtitle: Text(item['expense_category']?.toString() ?? 'Umum'),
